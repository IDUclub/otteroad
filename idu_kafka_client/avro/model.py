...
class AvroEventModel(BaseModel):
    ...
    Class Variables:
        topic: Kafka topic name (default: "default.events")
        schema_subject: Schema Registry subject (default: "default_subject")
    ...
    def _generate_avro_schema(cls) -> dict:
        ...
        result = {
            "type": "record",
            "name": cls.__name__,
            "namespace": f"{cls.topic}.{cls.__module__.rsplit('.', maxsplit=1)[-1]}",
            "fields": fields,
        }
